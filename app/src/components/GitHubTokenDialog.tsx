...
export function GitHubTokenDialog({ onClose }: { onClose: () => void }) {
  ...
  async function save() {
    ...
    try {
      ...
      toast({ kind: "success", title: t("collabToken.githubSaved") });
      setToken("");
      setHasToken(true);
      onClose();
    } catch (e) {
  ...
  async function clear() {
    ...
    try {
      ...
      toast({ kind: "success", title: t("collabToken.githubCleared") });
      setHasToken(false);
      setToken("");
    } catch (e) {
      toast({ kind: "error", title: (e as IpcError).message ?? String(e) });
    ...
    >
      ...
      >
        <div className="flex items-center gap-2 border-b border-line px-4 py-3">
          <h2 className="text-sm font-semibold text-fg">{t("collabToken.githubTitle")}</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="flex flex-col gap-3 px-4 py-4">
          ...
          <label className="flex flex-col gap-1">
            ...
            <input
              ...
              placeholder={t("collabToken.githubPlaceholder")}
